...
int main(int argc, char* argv[]) {
    ...
    // Set video path
    string videoPath = "/home/jupyter/Documents/projects/tf_cpp/tensorflow-object-detection-cpp/hands.mp4";
    ...
    // Get info
    int frame_width = (int64)cap.get(CAP_PROP_FRAME_WIDTH);
    int frame_height = (int64)cap.get(CAP_PROP_FRAME_HEIGHT);

    tensorflow::TensorShape shape = tensorflow::TensorShape();
    shape.AddDim(1);
    shape.AddDim(frame_height);
    shape.AddDim(frame_width);
    shape.AddDim(3);

    // Write results to new video file
    VideoWriter out("/home/jupyter/Documents/projects/tf_cpp/tensorflow-object-detection-cpp/hands_out.avi",
                    CV_FOURCC('M','J','P','G'), 25, Size(frame_width, frame_height));
